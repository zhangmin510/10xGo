...
// There can be many different binary trees with the same sequence of values stored 
// at the leaves. For example, here are two binary trees storing the sequence 1, 1, 
// 2, 3, 5, 8, 13.
// 
